...
import { Modal, Button, Row, Col, ProgressBar } from "react-materialize";
...
const Profile = () => {
    ...
    return (
        <React.Fragment>
            <Row>
                <Col s={12}>{loading ? <ProgressBar /> : ""}</Col>
            </Row>
                    ...
                    <div>
                        <h4>
                            ...
                            <Modal
                                ...
                                trigger={
                                    <Button node="button" className="black">
                        ...
                        <Button
                            className="black waves-effect waves-light"
